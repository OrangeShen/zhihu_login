...
var window = {
        'encodeURIComponent': function (url) {
            var newUrl = url.replace(/%/g, '%25').replace(/=/g, '%3d');
            return newUrl;
        }
    };
var navigator = {
...
G.prototype.v = function(e) {
    for (var t = new Buffer.from(e, 'base64').toString('binary'), n = [], r = 0; r < t.length - 1; r += 2)
        n.push(t.charCodeAt(r) << 8 | t.charCodeAt(r + 1));
    this.b = n
}
,
G.prototype.y = function(e) {
    for (var t = new Buffer.from(e, 'base64').toString('binary'), n = 66, r = [], o = 0; o < t.length; o++) {
